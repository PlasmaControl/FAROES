...
class Machine(om.Group):
    ...
    def setup(self):
        ...
        self.connect("totalbuild.radial_build.props.Ob SOL width",
                     "blanketgeom.Ob SOL width")
        self.connect("totalbuild.radial_build.ib.blanket R_max",
                     "blanketgeom.Ib blanket R_out")
        self.connect("totalbuild.radial_build.ib.blanket R_min",
                     "blanketgeom.Ib blanket R_in")

        self.connect("totalbuild.radial_build.ob.blanket R_in",
                     "blanketgeom.Ob blanket R_in")
        self.connect("totalbuild.radial_build.ob.blanket R_out",
                     "blanketgeom.Ob blanket R_out")

        self.connect("totalbuild.radial_build.ib.WC shield R_max",
                     "blanketgeom.Ib WC shield R_out")
        self.connect("totalbuild.radial_build.ib.WC shield R_min",
                     "blanketgeom.Ib WC shield R_in")
        self.connect("totalbuild.radial_build.ib.WC VV shield R_max",
...
if __name__ == "__main__":
    ...
    prob.model.add_design_var('totalbuild.CS R_max',
                              ...
                              ref=0.03,
                              units='m')
    prob.model.add_design_var('aspect_ratio', lower=1.6, upper=2.20, ref=1.6)
    ...
    prob.set_val("totalbuild.magnets.j_HTS", 100, units="MA/m**2")
    ...
    prob.set_val("plasma.<n_e>", 1.20, units="n20")
