import faroes.fusrate.halebosch as hb
...
class TestHaleBoschCrossSection(unittest.TestCase):
    ...
    def test_cross_section_dt(self):
        ...
        table_results = np.array([
            9.808e-3, 5.383e-1, 2.702e1, 4.077e2, 4.219e3, 3.427e3, 1.138e3,
            4.126e2
        ])
    ...
    def test_cross_section_dhe3(self):
        ...
        # in millibarns
        table_results = np.array([
            1.119e-11, 5.199e-8, 2.160e-4, 6.568e-2, 8.688e0, 1.021e2, 6.378e2,
            5.304e2
        ])
        self.compare_results(cs, table_results)
    ...
    def test_cross_section_ddpt(self):
        ...
        # in millibarns
        table_results = np.array([
            2.513e-4, 9.038e-3, 2.812e-1, 2.670e0, 1.557e1, 3.304e1, 5.234e1,
            7.005e1
        ])
        self.compare_results(cs, table_results)
    ...
    def test_cross_section_ddn3he(self):
        ...
        # in millibarns
        table_results = np.array([
            2.445e-4, 8.834e-3, 2.779e-1, 2.691e0, 1.649e1, 3.701e1, 6.239e1,
            8.702e1
        ])
        self.compare_results(cs, table_results)
...
class TestHaleBoschReactivity(unittest.TestCase):
    ...
    def compare_results(self, r, actual):
        code_results = r.reactivity(self.table_temperatures)
    ...
    def test_reactivity_dt(self):
        ...
        # results in cm³/s
        table_results = np.array([
            1.254e-26, 5.697e-23, 6.857e-21, 2.977e-19, 1.366e-17, 1.136e-16,
            4.330e-16, 8.649e-16
        ])
    ...
    def test_reactivity_dhe3(self):
        ...
        # results in cm³/s
        table_results = np.array([
            1.414e-35, 1.241e-29, 3.057e-26, 1.399e-23, 6.377e-21, 2.126e-19,
            3.482e-18, 5.554e-17
        ])
        self.compare_results(r, table_results)
    ...
    def test_reactivity_ddpt(self):
        ...
        # results in cm³/s
        table_results = np.array([
            4.640e-28, 1.204e-24, 1.017e-22, 3.150e-21, 9.024e-20, 5.781e-19,
            2.399e-18, 9.838e-18
        ])
        self.compare_results(r, table_results)
    ...
    def test_reactivity_ddn3he(self):
        ...
        # results in cm³/s
        table_results = np.array([
            4.482e-28, 1.169e-24, 9.933e-23, 3.110e-21, 9.128e-20, 6.023e-19,
            2.603e-18, 1.133e-17
        ])
        self.compare_results(r, table_results)
