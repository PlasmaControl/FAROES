from faroes.fusrate.reactionnames import reaction_name_simplify
from faroes.fusrate.reactionnames import reaction_name_to_endf

from importlib import resources

import numpy as np

DEFAULT_DATA_DIR = 'faroes.fusrate.data'
