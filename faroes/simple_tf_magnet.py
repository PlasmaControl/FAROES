...
class InnerTFCoilStrain(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('f_HTS',
                       0.76,
                       desc='Fraction of magnet area which is HTS')

        self.add_output('s_HTS',
                        0.066,
                        units='MPa',
                        desc='Strain on the HTS material')
        self.add_output('max_stress_constraint',
                        0.5,
                        desc='fraction of maximum stress on the HTS')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['max_stress_constraint'] = (self.hts_max_stress -
...
class MagnetGeometry(om.ExplicitComponent):
    ...
    def setup(self):
        self.add_input('r_ot',
                       0.405,
                       units='m',
                       desc='Magnet inenr leg outer structure radius')
        self.add_input('n_coil', 18, desc='number of coils')
        self.add_input('r_iu',
                       8.025,
                       units='m',
                       desc='Inner radius of outer TF leg')
...
class MagnetDesign(om.Group):
    def setup(self):
        ...
        self.add_subsystem('con_cmp2',
                           om.ExecComp('con2 = 18 - B_on_coil', B_on_coil=1),
